    ...
    <main className="container mx-auto p-8 max-w-2xl font-sans mt-8">
      <div className="bg-[#ECEBC9] rounded-3xl shadow-sm p-8 md:p-10 border border-[#D5E7B8]">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-3xl font-extrabold text-[#2c3e50]">Editar Despesa</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div>
            ...
            <input 
              ...
              required 
              className="w-full px-5 py-3 rounded-2xl border-none bg-white/80 focus:bg-white focus:ring-4 focus:ring-[#e74c3c]/30 outline-none transition-all"
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-6 pt-6 border-t border-[#D5E7B8]">
            <button type="submit" className="flex-1 bg-[#e74c3c] hover:bg-[#c0392b] text-white font-bold py-4 px-6 rounded-2xl transition-all shadow-md">
              Atualizar Dados
            </button>
